...
class DataListCP
{
    ...
    function GetPageList($atts,$refObj='',$fields=array())
    {
        ...
        if($this->pageNO != 1)
        {
            $prepage .= "<a class='prePage' href='".$purl."pageno=$prepagenum&doget=msgquery'>$lang_pre_page</a> \n";
            $indexpage = "<a class='indexPage' href='".$purl."pageno=1&doget=msgquery'>$lang_index_page</a> \n";
        }
        else
        {
        ...
        {
            $nextpage.="<a class='nextPage' href='".$purl."pageno=$nextpagenum&doget=msgquery'>$lang_next_page</a> \n";
            $endpage="<a class='endPage' href='".$purl."pageno=$totalpage&doget=msgquery'>$lang_end_page</a> \n";
        }
        else
        {
        ...
        {
            $listdd .= $j==$this->pageNO ? "<strong>$j</strong>\n" : "<a href='".$purl."pageno=$j&doget=msgquery'>".$j."</a>\n";
        }
