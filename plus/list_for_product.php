...
if(!empty($userid) && !empty($pwd))
{
	...
	{
		//$cuserLogin->keepUser();
		//include_once(DEDETEMPLATE.'/cts/product_show.htm');
		//exit();
		//echo true;//登陆成功
	}
	...
	{
		ResetVdValue();
		ShowMsg('你的用户名不存在!',$cfg_cmsurl.'/index.php',0,1000);
		//echo false;
		exit;
	}
	else
	{
		ResetVdValue();
		ShowMsg('你的密码错误!',$cfg_cmsurl.'/index.php',0,1000);
		//echo false;
		exit;
	}
}
...
{
	ResetVdValue();
	ShowMsg('用户和密码没填写完整!',$cfg_cmsurl.'/index.php',0,1000);
	//echo false;
	exit;
}
